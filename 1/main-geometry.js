...
function init() {
	...
	//! initialize objects
	var objMaterial = getMaterial('phong', 'rgb(255, 255, 255)');
	...
	var lightTop = getPointLight(5, 'rgb(255, 255, 255)');
	...
	lightTop.position.x = -10;
	lightTop.position.y = 10;
	...
	objMaterial.roughnessMap = loader.load('/images/scratch.jpg');
	objMaterial.bumpMap = loader.load('/images/scratch.jpg');
